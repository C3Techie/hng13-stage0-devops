...
**TASK EXPLAINER VIDEO:** [https://vt.tiktok.com/ZSUHFA4hK/](https://vt.tiktok.com/ZSUHFA4hK/)
...
- Requirements:  
  - Edit the provided `index.html` to include:  
    ```
...
2. Go to the `#track-devops` channel in Slack  
3. Run the command: `/stage-zero-devops`  
4. Submit:  
   - Your server IP (`http://your-ip-address/`)  
   - Your GitHub repo link  
5. Check Thanos bot for the error or success message after each attempt  
